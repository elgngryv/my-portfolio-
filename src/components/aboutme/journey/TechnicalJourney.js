    ...
    <div className="mt-5">
      ...
      <VerticalTimeline>
        ...
        <VerticalTimelineElement
          ...
          icon={<ComputerIcon />}
        >
          <h3 className="vertical-timeline-element-title">Redux,Context</h3>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentStyle={{ background: "rgb(78 22 112)", color: "#fbd9ad" }}
        ...
        <VerticalTimelineElement
          ...
          icon={<ComputerIcon />}
        >
          <h3 className="vertical-timeline-element-title">EmailJs</h3>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentStyle={{ background: "rgb(78 22 112)", color: "#fbd9ad" }}
        ...
        <VerticalTimelineElement
          ...
          icon={<ComputerIcon />}
        >
          <h3 className="vertical-timeline-element-title">Css,Sass</h3>
        </VerticalTimelineElement>
